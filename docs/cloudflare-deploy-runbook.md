...
- `/release.json`, `/site-health.json`, `/deploy-readiness`, `/deploy-readiness.json`, `/campaigns.json`, `/creator-kit.json`, `/share-kit.json`, `/traffic-launch.json`, `/noor-sprint-status`, `/noor-sprint-status.json`, `/links`, `/links.json`, `/conversion-health`, `/conversion-health.json`, `/products`, `/zh/products`, `/ar/products`, `/product-samples/koko-printable`, `/product-samples/noor-worksheet`, `/products.json`, `/monetization-roadmap`, `/monetization-roadmap.json`, `/video-discovery.json`, `/shortlinks.json`, `/sitemap.xml`, and `/robots.txt` are readable
