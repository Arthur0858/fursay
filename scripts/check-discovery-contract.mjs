...
const PUBLIC_PAGES = [
  ...
  "/zh/products",
  "/ar/products",
  "/products/koko-printable",
  "/products/noor-worksheet",
  "/zh/products/koko-printable",
  "/zh/products/noor-worksheet",
  "/ar/products/koko-printable",
  "/ar/products/noor-worksheet",
  "/privacy",
  "/zh/privacy",
  "/ar/privacy",
  "/support",
