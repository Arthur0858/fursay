...
async function checkDiscoveryFiles(baseUrl) {
  ...
  if (release.liveExpectations?.amazonAffiliateLinks !== 27) failures.push(`release_amazon_affiliate_link_expectation:${release.liveExpectations?.amazonAffiliateLinks || "none"}`);
