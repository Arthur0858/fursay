...
async function checkDiscoveryFiles(baseUrl) {
  ...
  if (release.liveExpectations?.cacheHeaderChecks !== 31) failures.push(`release_cache_expectation:${release.liveExpectations?.cacheHeaderChecks || "none"}`);
