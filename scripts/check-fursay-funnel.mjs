...
async function checkDiscoveryFiles(baseUrl) {
  ...
  if (release.liveExpectations?.cacheHeaderChecks !== 37) failures.push(`release_cache_expectation:${release.liveExpectations?.cacheHeaderChecks || "none"}`);
