...
async function main() {
  ...
  if (!products.nextValidationHandoff?.priorityReason?.includes("active first validation package")) failures.push("products_manifest_handoff_missing_priority_reason");
