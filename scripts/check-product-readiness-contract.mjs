...
async function main() {
  ...
  if (!html.includes("site-shared-20260615-noorpdf1.js")) failures.push("products_page_missing_shared_js");
  if (!zhHtml.includes("site-shared-20260615-noorpdf1.js")) failures.push("zh_products_page_missing_shared_js");
  if (!arHtml.includes("site-shared-20260615-noorpdf1.js")) failures.push("ar_products_page_missing_shared_js");
